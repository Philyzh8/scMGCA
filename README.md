...
`scMGCA` is a Python package containing tools for clustering using multiscale graph correlation and other statistical tests, that is capable of dealing with high dimensional and multivariate data.
